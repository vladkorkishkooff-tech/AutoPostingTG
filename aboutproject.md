...
- Локальная история постов и картинок для защиты от повторов.
...
├── content_history.py   # Локальная история для дедупликации
...
Хранит историю отправленных текстов и URL изображений в `data/content_history.json`. Эта история нужна, чтобы бот не повторял недавние факты и фотографии.
...
- Перенести JSON-историю в SQLite при росте проекта.
